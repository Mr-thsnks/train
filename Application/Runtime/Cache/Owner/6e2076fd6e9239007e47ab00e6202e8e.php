...
<div class="ulb">
    ...
    <ul>
        ...
        <li class="btn btn-default disabled" role="button">
            ...
            <div>
                <div class="hint"></div>
                <table class="table center-block" style="width:97.5%; margin-bottom:0px;">
    <tr style="background-color:#e8e8e8;">
        <td colspan="2" align="center">字典设置</td>
    </tr>
    <tr>
        <td align="center"></td>
        <td align="right">
            <a href="<?php echo U('/Setting/create', array('table'=>I('get.table'), 'bid'=>I('get.bid')));?>" class="btn btn-sm btn-success">新增</a>
        </td>
    </tr>
</table>
<table class="table table-bordered center-block" style="width:97.5%; margin-top:0px;">
    ...
    <?php if($results): if(is_array($results)): foreach($results as $key=>$val): ?><tr align="center">
                ...
                <td><?php echo ($val["name3"]); ?></td>
                <td><?php echo ($val["name4"]); ?></td>
                <td><?php echo ($val["status_text"]); ?></td>
                <td><?php echo (findAuth($val["operator"])); ?></td>
                <td width="75px">
                    <a href="<?php echo U('/setting/update', array('table'=>'dict', 'bid'=>I('get.bid'), 'id'=>$val['id']));?>" class="btn btn-sm btn-warning" >编辑</a>
                </td>
            </tr><?php endforeach; endif; ?>
    <?php else: ?>
        <tr align="center">
            <td class="text-center" colspan="99">暂无字典设置</td>
        </tr><?php endif; ?>
</table>
