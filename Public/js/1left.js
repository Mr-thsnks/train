...
function switchSysBar(){
	...
	var main=document.getElementById("main");
     if (1 == window.status){
          ...
          switchPoint.style.backgroundImage = 'url(/Public/images/left.png)';
          frmTitle.style.display="none"
		  main.style.width="99.5%"
     }
     else{
		  window.status = 1;
          switchPoint.style.backgroundImage = 'url(/Public/images/right.png)'; 
          frmTitle.style.display=""
		    main.style.width="86.5%"
     }
}
