...
document.write("<div id='ColorPicker' style='opacity:1;-moz-opacity:1;filter:alpha(opacity=100);     z-index: 9999;position:absolute; left:0px; top:0px;background:#efefef;border:1px solid #cccccc;padding:10px 20px;display:none;'>")
...
document.write("<div align='center' style='padding:5px'><input type='button' style='border:1px solid #999999; background:#eeeeee' value=' 确定 ' onclick='setColor()'>&nbsp;&nbsp;&nbsp;<input type='button' style='border:1px solid #999999; background:#eeeeee' value=' 取消 ' onclick=\"$('ColorPicker').style.display='none'\"></div>")
document.write("")
document.write("</div>")
...
function CreateCPBtn(inputName){
    ...
    document.write("<img style=\"float:left;height:30px;\" src=\"../style/images/Rect.gif\" style=\""+CPBtnStyle+"\" align=\"absmiddle\" onClick=\"showColorPicker(this,event,'"+inputName+"')\">")	
}
